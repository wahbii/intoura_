...
export class DriverEntity {
  ...
  @ManyToMany(() => RiderEntity, (rider) => rider.favoriteDrivers)
  ridersFavorited!: RiderEntity[];

  @ManyToMany(() => RiderEntity, (rider) => rider.blockedDrivers)
  ridersBlocked!: RiderEntity[];
